...
var Scopes_Facebook = []string{"id","name","first_name","last_name","middle_name","picture"}
var URL_access_token_Facebook = "https://graph.facebook.com/me?fields=email,id,name,first_name,last_name,middle_name,picture&access_token="
